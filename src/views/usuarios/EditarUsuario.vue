  ...
  <div>
    <div class="tw:container tw:mx-auto tw:py-[20px] tw:px-4 tw:sm:px-6 tw:lg:px-8">
      <div class="tw:flex tw:items-center tw:gap-4">
        ...
        <div>
          <p class="q-mb-none tw:text-[30px] tw:font-bold">Editar Usuário</p>
          <p class="q-mb-none tw:text-[16px] tw:leading-[24px]">Edite as informações do usuário</p>
        </div>
      </div>
      ...
      >
        ...
        <q-form style="margin: 12px 0" @submit.prevent="Editar" ref="formRef">
          <div class="row q-col-gutter-md tw:my-4">
            <div class="col-3">
              <label class="tw:text-gray-500 tw:dark:text-gray-200">ID do usuário</label>
              <q-input v-model="id_usuario" readonly outlined dense />
            </div>
          </div>
          ...
          <div class="row q-col-gutter-md tw:my-4">
            <div class="col-6">
              ...
              <q-input
                ...
                lazy-rules="ondemand"
                hint="Deixe o campo em branco para não alterar a senha"
              />
            </div>
...
async function Editar() {
  ...
  try {
    await api.patch(`/usuarios/${form.value.id}`, form.value);
    router.push("/usuarios");
  } catch (err) {
